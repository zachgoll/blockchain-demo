...
var CreateBlockComponent = (function () {
    ...
    CreateBlockComponent.prototype.ngOnInit = function () {
        ...
        setInterval(function () {
            if (!_this.mining && _this.selectedTxs.length === 0) {
                _this.loadTxs();
            }
        }, 20000);
        setInterval(function () {
